//P being the accumulator that keeps track of the values, and v being the individual items that are getting added
...
function show_service_to_salary_correlation(ndx) {
    ...
    var minExperience = eDim.bottom(1)[0].yrs_service; //We take the bottom(1) value, and that gives us our minimum. And we take the top(1) value of that dimension to get our maximum years of service.
    ...
    dc.scatterPlot("#service-salary")
        ...
        //The title is going to be what will appear if you hover the mouse over a dot.
        .title(function(d) {                                        
            return d.key[2] + " earned " + d.key[1];
        })
        .colorAccessor(function (d) {
            return d.key[3]; //number 3
        })
        .colors(genderColors) 
...
function show_phd_to_salary_correlation(ndx) {
    ...
    var minphd = pDim.bottom(1)[0].yrs_since_phd; //We take the bottom(1) value, and that gives us our minimum. And we take the top(1) value of that dimension to get our maximum years of service.
